...
//VARIABLES---------------------------------------------------------------
#define motorSpeed 255               //motor speed bwtween 0 and 255: a value of less than 150 does not usually work
#define pivotSpeed motorSpeed / 40   //pivot motor speed
#define turnSpeed motorSpeed / 2     //turning motor speed
#define t 10                          //millisecond time between loops: Smaller is better but increases "twitchiness"
#define offLineTime 40               //Time to turn and to drive forward once flag is set and called forward
#define offLineTimeFlag 10
//int startButton = 13;               //Start button on pin 13
#define leftBumper 9                 //Left Bumper on pin 9
#define rightBumper 10                 //Right Bumper on pin 10

byte startButtonValue = 0;
byte leftBumperValue = 0;            //Left Bumper value set to 0 (TX)
byte rightBumperValue = 0;           //Right Bumper value set to 0 (RX) 
byte farLeft = 0;                    //Channel 0 initialization
byte left = 0;                       //Channel 1 initialization
byte middle = 0;                     //Channel 2 initialization
byte right = 0;                      //Channel 3 initialization
byte farRight = 0;                   //Channel 4 initialization
byte leftFlag = 0;                   //Flag when last known sensor value is the left sensor: used when line is lost
byte rightFlag = 0;                  //Flag when last known sensor value is the right sensor: used when line is lost
